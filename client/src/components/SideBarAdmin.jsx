...
const SideBarAdmin = () => {
  ...
  return (
    <nav
      className={`md:h-screen lg:h-screen sm:h-min sm:w-full md:w-fit lg:w-fit transition-all duration-300 flex md:flex-col lg:flex-col sm:flex-row  sticky  left-0 top-0 p-2  pt-24 rounded-sm shadow-md border bg-white  ${
      ...
      <ul className="flex md:flex-col lg:flex-col sm:flex-row w-full  justify-center">
        <li>
          ...
          >
            ...
            {expanded && showText && <p className="hidden sm:block">Requests</p>}
          </Link>
        </li>
        <li>
          <Link
          ...
          >
            ...
            {expanded && showText && <p className="hidden sm:block">Active</p>}
          </Link>
        </li>
        <li>
          <Link
          ...
          >
            ...
            {expanded && showText && <p className="hidden sm:block">Records</p>}
          </Link>
        </li>
        <li>
          <Link
          ...
          >
            <img alt="requests" className="w-6 mr-4" src="/records.svg" />
            {expanded && showText && <p className="hidden sm:block">Upload Add</p>}
          </Link>
        </li>
        <li>
          <Link
          ...
          >
            <img alt="requests" className="w-6 mr-4" src="/active.svg" />
            {expanded && showText && <p className="hidden sm:block">feedback</p>}
          </Link>
        </li>
      </ul>
    </nav>
