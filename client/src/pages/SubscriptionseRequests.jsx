...
function SubscriptionseRequests() {
  ...
  useEffect(() => {
    const fetchSubscriptions = async () => {
      try {
        const response = await axios.get("https://brotein-bistro-production.vercel.app/api/subs/subscriptions");
  ...
  const handleApprove = async (id) => {
    try {
      ...
      const response = await axios.put(`https://brotein-bistro-production.vercel.app/api/active/subs/approve/${id}`, {
        phoneNumber,
        address,
        selectedPlan,
        startDate,
  ...
  const handleDecline = async (id) => {
    try {
      await axios.delete(`https://brotein-bistro-production.vercel.app/api/subs/subscriptions/${id}`);
